...
def generate(schema: dict, output: Path):
    ...
    for asynchronous in (False, True):
        ...
        classes.append("\n".join(lines))
    source = '''# Generated by pycelld. Regenerate after changing the worker contract.
from __future__ import annotations
...
from celld import ClientInfo, RetryPolicy
from celld.client import Client as _Client, AsyncClient as _AsyncClient
